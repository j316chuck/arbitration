function hyperparam_analysis()  
    ...
    write_metrics_table(metrics, control_schemes, blend_schemes, params, output_csv_path, verbose); 
end

function [metrics, exp_names] = get_metrics(output_folder, starts, goals, ...
        control_schemes, blend_schemes, params, verbose)   
    Ns = 20; % start and goal pairs
...
function write_metrics_table(metrics, control_schemes, blend_schemes, params, csv_path, verbose)
