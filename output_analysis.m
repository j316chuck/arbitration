...
%     path = strcat(repo.path, '/old_outputs/option_4_triangle');
%     exp_types = {
...
%     end 
    ...
    exp_types = {
        'blending_scheme_time_varying_value_blend_safety_control_traj_replan_dt_1.500_spline_obs_weight_1.000000'
    };
