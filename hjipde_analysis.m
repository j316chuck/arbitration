function output_analysis()  
    ...
    blend_schemes = {'none'}; % get_key_blend_schemes(); 
    [starts, goals] = get_point_nav_tasks("simple_env"); %"simple_env" %"sampled" %"smoke_test"
            ...
            for k = 1:Nb
                for i = 1:Ns
                    ...
                    for it = 1:length(dirs)
                        ...
                        fprintf("Method %s Update Times: \n", obj.brs_planner.updateMethod); 
                        fprintf("%.2f ", obj.hjipde_time); 
                        fprintf("\n"); 
