function [hyperparam_str] = get_hyperparam_string(params)
    base_str = sprintf("grid_%s_zls_%.3f_replan_dt_%.3f_obs_weight_%.3f_sensor_%s_radius_%.2f_update_%s", ... 
        params.grid_size, params.zero_level_set, params.replan_dt, ...
        params.spline_obs_weight, params.sensorArgs.sensor_shape, ...
        params.sensorArgs.sensor_radius, params.updateMethod); 
